  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Log Exclusion</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Record a meal session exclusion for a school.</p>
      </div>
      <ExclusionForm schools={schools ?? []} />
    </div>
  );
}
